...
const INITIAL_MESSAGE: Message = {
  role: "assistant",
  text: "Hey! I'm Aftar's AI assistant. Ask me about his experience, skills, or projects. Try typing 'experience', 'skills', or 'projects'.",
};
    ...
    >
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mb-8 font-mono text-xs text-muted-foreground/50">
          Powered by keyword matching — upgrade to real AI coming soon
        </p>
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-card">
          ...
          <div className="flex gap-3 border-t border-border p-4">
            <input
              ...
              className="flex-1 rounded-xl border border-border bg-muted px-4 py-2.5 font-mono text-sm text-foreground placeholder-muted-foreground focus:border-primary/50 focus:outline-none"
            />
            <button
